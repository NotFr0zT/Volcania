...
module.exports = {
    ...
    run: async (client, message, args) => {
        try {
            ...
            if (db.fetch(`moderation_${message.guild.id}`) === null) return message.channel.send(`Moderation is not enabled in ${message.guild.name}! \`Type v!moderation on\` to turn it on!`)
